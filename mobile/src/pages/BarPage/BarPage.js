...
export default function ParPage({navigation}){
            ...
            <ScrollView>
                ...
                <View style={styles.header}>
                    <View style={styles.backAndName}>
                        <Ionicons name="ios-arrow-back" size={60} color="#F4AA1D" onPress={()=>{navigation.pop()}}/>
                        <Text style={styles.barName}> {bar.name} </Text>
                    </View>
                    <View style={styles.clientsContainer}>
                        <FontAwesome name="users" size={30} color="#ffffff" />
                        <View style={styles.clientsString}>
                            <Text style={styles.clientsNumber}> 84</Text>
                ...
                <View style={styles.stars}>
                    <Stars
                        display={
                            (avaliation.bar_drinks + avaliation.bar_cleaning + avaliation.bar_drinks + avaliation.bar_price + avaliation.bar_foods + avaliation.bar_space)/6
                        }
                        spacing={8}
                        count={5}
                        starSize={40}
                ...
                <View style={styles.tabBar}>
                    <TouchableHighlight onPress={()=>{setTab('description')}} >
                        {
                            (tab==='description') ?
                    ...
                    <TouchableHighlight onPress={()=>{setTab('avaliations')}}>
                        {
                            (tab==='avaliations') ?
                            <View style={styles.tabHighlight}>
                    ...
                    <TouchableHighlight onPress={()=>{setTab('menu')}}>
                        {
                            (tab==='menu') ?
                            <View style={styles.tabHighlight}>
                    ...
                    <TouchableHighlight onPress={()=>{setTab('comments')}}>
                        {
                            (tab==='comments') ?
                            <View style={styles.tabHighlight}>
